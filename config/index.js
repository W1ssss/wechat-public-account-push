export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9389a8fba776618f",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "516302795d0599da3ac0012c3eecc7ac",
  ...
  USERS: [
    {
      ...
      id: "oexb550VfaxN3qFui8cU7mER6BBg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "LGnoSgUQm8qpjGSaBrfcWvl3Ct_45jAcXAXe_lWCMlQ",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
